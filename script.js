...
var hurousyotoku_syuukai = setInterval(hurousyotoku,1000);
...
var hurousyotoku_youtuber = setInterval(subscriber,1000)
var 購入数_utyuu = 0;
...
var subscriber_wakusei_syuukai = setInterval(subscriber_wakusei,1000);
